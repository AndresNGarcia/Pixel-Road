"""
game_screen.py – Pantalla de juego para 2 jugadores locales (Pixel Road).
Mejoras sobre el código original:
  - 2 jugadores en la misma pista (carros distintos, carriles separados)
  - Nombres de jugadores en el HUD
  - Teclas distintas para cada jugador (A/D para J1 | ←/→ para J2)
  - HUD con vidas y puntaje individual
  - Velocidad progresiva, invencibilidad, parpadeo
  - Game over con ganador y puntaje final
  - Pausa (P / Escape)
"""
...
CAR_Y         = 570
MAX_LIVES     = 3
INVINCIBLE_T  = 90        # ticks de invencibilidad tras colisión
BLINK_P       = 8
INITIAL_SPEED = 5
SPEED_INC     = 0.4
MAX_SPEED     = 18
