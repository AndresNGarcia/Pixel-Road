...
class ScoreScreen(QWidget):
    ...
    def __init__(self):
        ...
        titulo.setStyleSheet("color: gold;")
        ...
        btn_volver.clicked.connect(self.volver_menu.emit)
    ...
    def cargar_scores(self):
        ...
        if not os.path.exists(self.score_path):
            self.score_box.setText("No hay puntajes aún.")
            return
        ...
        try:
            ...
            for i, jugador in enumerate(scores, start=1):
